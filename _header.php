...
// Assuming $conn is properly initialized in dbconnect.php
...
// Assuming $conn is properly initialized and connected
...
if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true && isset($_SESSION['useremail'])){
